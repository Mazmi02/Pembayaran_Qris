                ...
                <div id="receipt-capture" class="p-4 pt-6 pb-6 bg-gray-100 flex flex-col items-center">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden w-full border border-gray-200">
                        ...
                        <div style="display: block !important; text-align: center !important; width: 100% !important; padding: 32px 24px 24px 24px; box-sizing: border-box;">
                            ...
                            <h2 style="font-size: 20px; font-weight: 700; color: #1f2937; margin: 0 !important; padding-left: 65px !important; text-align: left !important; width: 100% !important; display: block !important; line-height: 1.4; border: none !important;">Pembayaran Berhasil</h2>
